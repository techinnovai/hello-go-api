...
const file_hello_v1_hello_proto_rawDesc = "" +
	"\n" +
	"\x14hello/v1/hello.proto\x12\bhello.v1\"\x0e\n" +
	"\fHelloRequest\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2K\n" +
	"\fHelloService\x12;\n" +
	"\bSayHello\x12\x16.hello.v1.HelloRequest\x1a\x17.hello.v1.HelloResponseB:Z8github.com/techinnovai/hello-go-api/gen/hello/v1;hellov1b\x06proto3"
...
var file_hello_v1_hello_proto_depIdxs = []int32{
	...
	1, // 1: hello.v1.HelloService.SayHello:output_type -> hello.v1.HelloResponse
